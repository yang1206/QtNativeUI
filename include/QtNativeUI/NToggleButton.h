...
class QTNATIVEUI_EXPORT NToggleButton : public QWidget {
    ...
    Q_PROPERTY_CREATE_Q_H(QColor, AccentDefaultColor)
    Q_PROPERTY_CREATE_Q_H(QColor, AccentHoverColor)
    Q_PROPERTY_CREATE_Q_H(QColor, AccentPressColor)
    Q_PROPERTY_CREATE_Q_H(QColor, AccentDisabledColor)
    Q_PROPERTY_CREATE_Q_H(QColor, AccentTextColor)
    Q_PROPERTY_CREATE_Q_H(QColor, AccentDisabledTextColor)
