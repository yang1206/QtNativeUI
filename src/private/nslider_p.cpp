...
void NSliderPrivate::Style::drawTrack(const QStyleOptionSlider* option, QPainter* painter, const QWidget* widget) const {
    painter->save();
...
void NSliderPrivate::Style::drawProgress(const QStyleOptionSlider* option, QPainter* painter, const QWidget* widget) const {
    painter->save();
...
void NSliderPrivate::Style::drawHandle(const QStyleOptionSlider* option, QPainter* painter, const QWidget* widget) const {
    painter->save();
...
void NSliderPrivate::Style::drawTicks(const QStyleOptionSlider* option, QPainter* painter, const QWidget* widget) const {
    painter->save();
    ...
    if (option->orientation == Qt::Horizontal) {
        ...
        for (int value = option->minimum; value <= option->maximum; value += interval) {
            double ratio = (value - option->minimum) / static_cast<double>(valueRange);
            int tickY = option->rect.height() - padding - static_cast<int>((option->rect.height() - 2 * padding) * ratio);
